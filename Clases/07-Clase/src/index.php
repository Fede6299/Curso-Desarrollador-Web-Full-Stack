...
//LA POSICIÓN DEL PRIMER ELEMENTO DE LOS ARRAYS EN PHP ES 0
...
array_push($array3, 100); //AGREGO UN ELEMENTO DE LA ULTIMA POSICIÓN
var_dump($array3);
echo "<br>";
...
//TENGO UN ARRAY DE N ELEMENTOS => CUAL ES LA POSICIÓN DEL ULTIMO ELEMENTO?
//LA POSICIÓN DEL ULTIMO ELEMENTO ES N - 1
...
//WARNING
//echo $arrayAsociativo["dirección"];
//echo "<br>";
...
//DEFINÍ LA FUNCIONALIDAD DE LA FUNCIÓN
function saludar(){
    echo "Hola mundo!!!!";
    echo "<br>";
}

//LLAMADO O INVOCACIÓN A LA FUNCIÓN
saludar();
saludar();
saludar();
saludar();
...
//CUANDO UNA VARIABLE ESTA "VACÍA" - EMPTY
$array = [];
...
function operacionesMatematicas($numero1,$numero2){
    ...
    //CUANDO UNA VARIABLE ES "NUMÉRICA" - is_numeric
