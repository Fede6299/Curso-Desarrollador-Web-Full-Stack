...
var_dump("5" === 5); //COMPARO LOS VALORES ABSOLUTOS Y TAMBIÉN LOS TIPOS DE DATOS
echo "<br>";
*/

/*
//OPERADOR DE NEGACIÓN (INVERSA/NOT)
...
switch($numero){
    case 1:
        //código que se ejecuta cuando el $numero == 1
...
if($numero == 1){
    //código para numero es 1
}
elseif($numero == 2){
    //código para numero es 2
}
elseif($numero == 5){
    //código para numero es 5
}
else{
    //valor por defecto
}
...
switch($diaSemana){
    case "Lunes":
    case "Viernes":
        echo "Tengo clases de programación";
        echo "<br>";
        break;
    case "Martes":
    case "Miércoles":
    ...
    case "Sábado":
    case "Domingo":
        echo "No tengo clases de programación";
        echo "<br>";
        break;
    case "1":
...
//ESTRUCTURA DE REPETICIÓN WHILE (ESTRUCTURA DE REPETICIÓN INEXACTA)

/*
$variableControl = 0;

while($variableControl < -5){
    //instrucciones a ejecutar y ademas, se va a realizar la actualización de la variable de control
    echo "Estoy adentro del bucle while y el valor de variableControl es: " . $variableControl;
    echo "<br>";
    //$variableControl = $variableControl + 2;
    //$variableControl += 2;
    $variableControl++; //SUMARLE UNO A LO QUE HABÍA Y ASIGNAR A LA MISMA VARIABLE
}

echo "Estoy afuera del while y el valor de la variableControl es: " . $variableControl;

//EL CICLO WHILE PUEDE ITERAR COMO MÁXIMO INFINITA CANTIDAD DE VECES
//EL CICLO WHILE PUEDE ITERAR COMO MÍNIMO 0 CANTIDAD DE VECES
*/
...
//EL CICLO WHILE PUEDE ITERAR COMO MÁXIMO INFINITA CANTIDAD DE VECES
//EL CICLO WHILE PUEDE ITERAR COMO MÍNIMO 1 CANTIDAD DE VECES
*/

//ESTRUCTURA DE REPETICIÓN FOR (ESTRUCTURA DE REPETICIÓN EXACTA)

// 1) PRECONDICIÓN (OPCIONAL) => definir la variable control y su valor inicial (solo se ejecuta una vez, cuando ingreso por primera vez al bucle)
// 2) CONDICIÓN LÓGICA => es la que se va a evaluar y define si se sigue iterando o no. (Relacionada con la variable de control)
// 3) POST CONDICIÓN (OPCIONAL) => definir la actualización de la variable control y se ejecuta siempre cuando termina un ciclo de iteración.
